    ...
    <div class="container-fluid py-2" style="margin-top: 10px">
        <div class="container-fluid px-4 px-lg-6 mt-4">
            ...
            foreach ($search_result as $product) {
                ...
                if ($product->sale) {
                    echo '<div class="badge bg-dark text-light position-absolute" style="top: 0.5rem; right: 0.5rem"> - ' . $product->sale . '%</div>';
                }
                
                echo '<img class="card-img-top" src="' . $product->img . '" alt="..." style="height: 80%; width: auto;">
                ...
                if ($product->vote_number == 0) {
                    echo '<p class="product-name text-muted" style="font-size: 1em">' . $product->vote_number . ' lượt đánh giá</p>';
                } else {
                    echo '<p class="product-name text-muted" style="font-size: 1em">' . $product->vote_number . ' lượt đánh giá</p>
                          <p class="product-name text-muted" style="font-size: 1em">' . $product->total_stars / $product->vote_number . ' đánh giá trung bình</p>';
                }
