        ...
        <div class="container">
            ...
            <div class="product-content row">
                <div class="product-content-left row">
                    <div class="big-img">
                        <img src="<?php echo $product->img;?>" alt="bigImage">
                    </div>
                    <div class="small-img">
                ...
                <div class="product-content-right">
                    ...
                    <div class="product-button">
                        <input type="submit" form="product-form" class="addCart" name="addCart" value="THÊM VÀO GIỎ">
                        <input type="submit" form="product-form" class="buyProduct" name="buyProduct" value="MUA HÀNG">
                    </div>
