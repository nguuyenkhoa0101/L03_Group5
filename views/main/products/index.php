                ...
                <div id="card" class="col mb-3">
                    <div class="card h-100 rounded-2">
                        ...
                        <div class="badge bg-warning text-dark position-absolute" style="top: 0.5rem; right: 0.5rem">
                            SALE <?php echo  $product->sale; ?> %</div>
                        <?php }?>
                        <img class="card-img-top" src="/Web/<?php echo $product->img; ?>" style="height: 300px;"
                            alt="..." />
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                ...
                                <?php if ($product->sale > 0) {?>
                                <span
                                    class="red"><?php echo number_format($product->price*(100-$product->sale)/100, 0, ',', '.'); ?>
                                    VNĐ</span></span> <span class="money-unit"></span>
                                <span
                                    class="text-muted text-decoration-line-through"><?php echo number_format($product->price, 0, ',', '.') ?>
                                    VNĐ</span>
                                <?php }
                              else {
                           ?>
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto"
                                        href="index.php?page=main&controller=detail&id=<?php  echo $product->id;?>&action=index">Xem
                                        thêm</a></div>
                            </div>
