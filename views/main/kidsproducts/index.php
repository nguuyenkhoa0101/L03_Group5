        ...
        <div class="container-fluid px-4 px-lg-6 mt-4">
            ...
            foreach ($kidsproducts as $kidsproduct) {
                echo '<div id="card" class="col mb-3">
                    <a href="index.php?page=main&controller=detail&id=' . $kidsproduct->id . '&action=index" class="card h-100 text-decoration-none">';
                
                if ($kidsproduct->sale) {
                    echo '<div class="badge bg-dark text-light position-absolute" style="top: 0.5rem; right: 0.5rem"> - ' . $kidsproduct->sale . '%</div>';
                }
            
                echo '<img class="card-img-top" src="' . $kidsproduct->img . '" alt="..." style="height: 80%; width: auto;">
                    <div class="card-body p-4">
                        <div class="text-center">
                            <p class="product-name text-muted" style="font-size: 1em">' . $kidsproduct->name . '</p>
                            <span class="fw-bold">' . number_format($kidsproduct->price * (100 - $kidsproduct->sale) / 100, 0, ',', '.') . ' đ</span>
                            <span class="text-muted text-decoration-line-through">' . number_format($kidsproduct->price, 0, ',', '.') . ' đ</span>
                        </div>
                    </div>
