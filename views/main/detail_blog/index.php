...
<body>
  ...
  <section id="blog" class="blog" style="margin-top: 7.5%;">
    <div class="container" data-aos="fade-up">
      ...
      // Kiểm tra xem session "guest" có tồn tại hay không
      if(isset($_SESSION["guest"])) {
          ...
          // Hiển thị thông báo khi session "guest" không tồn tại
          echo '<p style="color: red;">Bạn cần đăng nhập trước khi bình luận</p>';
      }
