    ...
    <div class="row">
        <div class="col-md-12 col-lg-4 col-xl-4">
            <div class="row mt-2">
                <div class="card h-100">
                    <div class="badge bg-warning text-dark position-absolute" style="top: 0.5rem; right: 0.5rem">SALE
                        <?php echo $product->sale;?> %</div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-8 col-xl-8 mt-4">
                ...
                <div class="mt-2 text-center mb-2 ">
                    <button id="addToCartBtn" class="btn btn-outline-warning" type="button">Thêm vào giỏ hàng</button>
                    <button class="btn btn-outline-danger" type="button">Mua ngay</button>
                </div>
            </div>';
            <?php
