            ...
            <div class="my-3">
                ...
                <?php foreach($order_info as $k => $info) {?>
                    ...
                    <tbody> 
                        ...
                        <th class="d-none d-lg-table-cell" style="text-align:center"><?php echo $info['email']?></th>
                        <th class="d-none d-lg-table-cell" style="text-align:center"><?php echo $info['location']?></th>
                        <th class="d-none d-lg-table-cell" style="text-align:center"><?php echo $info['phone']?></th>
                    </tbody>
                    </table>
                    </div>
                    ...
                    <div class="shadow p-2 rounded">
                        <div class="">
                            ...
                            <div class="row">
                                    ...
                                    <table id="tab-comment" class="table table-bordered table-striped shadow">
                                        <thead>
                                            ...
                                            <tr class="text-center">
                                                ...
                                                <th class="d-none d-lg-table-cell">Tên đơn hàng</th>
                                                ...
                                                <th class="d-none d-lg-table-cell">Khuyến mãi</th>
                                            ...
                                            foreach ($order_details as $key => $ord) { 
                                                ...
                                                <tr class="text-center">
                                                  <?php $i++ ; ?>
                                                    ...
                                                    <td class="d-none d-lg-table-cell">
                                                    <img style="width: 100px; height:100px;" src='<?php echo $ord['img'] ?>'>    
                                                    </td>   
                                                    <td class="d-none d-lg-table-cell">
                                ...
                                <form method="POST" action="index.php?page=admin&controller=order_details&action=confirm">
                                <div class="input">
                                    <input type="hidden" value="<?php echo $id ?>" name="order_code" id="order_code">
                                    <input type="submit" value="Cập nhật đã thanh toán" name="confirm_cart" class="btn btn-sm btn-primary" name="formsubmit" id="formsubmit">
