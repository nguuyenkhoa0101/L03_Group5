        ...
        <nav class="navbar navbar-expand-lg navbar-light bd-subnavbar py-2">
            ...
            <div class="collapse navbar-collapse hide" id="navbarSupportedContent">
                <div class="menu-container">
                    ...
                    <li class="menu"><a href="index.php?page=main&controller=kidsproducts&action=index">
                            FOR KIDS</a></li>
                ...
                <li id="cart" class="menu">
                        <a data-bs-toggle="tooltip" data-bs-placement="bottom" <?php if(isset($_SESSION["guest"])) {?> href="index.php?page=main&controller=cart&action=index" <?php } else ?> href="index.php?page=main&controller=login&action=index" >
