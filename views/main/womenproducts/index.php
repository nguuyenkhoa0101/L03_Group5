...
<main>
    ...
    <div class="d-flex justify-content-between align-items-start">
        <div class="text-left">
            <p class="product-name fw-bold text-dark" style="font-size: 1em">' . $womenproduct->name . '</p>
            <div class="d-flex align-items-center"> <!-- Added a new container for flex layout -->
                <span class="fw-bold">' . number_format($womenproduct->price * (100 - $womenproduct->sale) / 100, 0, ',', '.') . 'đ</span>
            <span class="text-muted text-decoration-line-through ms-2">' . number_format($womenproduct->price, 0, ',', '.') . 'đ</span>
            <i class="fas fa-shopping-bag ms-auto"></i> <!-- Align to the right -->
            </div>
            </div>
    </div>
</div>
